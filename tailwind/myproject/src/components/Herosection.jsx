...
const Hero = () => {
  return (
    <div
      className="bg-[url('https://cdn.leonardo.ai/users/0eb6c3b1-3b1a-4bb0-a1fe-13b274daa174/generations/fafaaaf4-4ff3-4ddb-a6ee-8c6dae0f8929/segments/2:4:1/Flux_Dev_Create_a_blackandwhite_silhouette_of_a_motorcyclist_r_1.jpeg')] bg-cover h-[700px] text-white py-20 w-full"
    >
